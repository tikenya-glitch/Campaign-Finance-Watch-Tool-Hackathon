    ...
    return (
        <div className="relative w-full" ref={wrapperRef}>
            <button
                ...
                className="w-full flex items-center justify-between bg-white border border-slate-300 p-2 rounded text-sm text-slate-700 hover:border-slate-400 focus:outline-none focus:ring-1 focus:ring-blue-500 min-h-[42px] shadow-sm"
            >
            ...
            {isOpen && (
                <div className="absolute z-[100] w-full mt-1 bg-white border border-slate-200 rounded-md shadow-xl max-h-80 flex flex-col">

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 leading-relaxed max-w-md">
              Leading platform for monitoring political donations, detecting suspicious financial activity, and promoting transparency in campaign financing across the nation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#portal" className="text-gray-300 hover:text-white transition-colors">Citizen Portal</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#api" className="text-gray-300 hover:text-white transition-colors">API Access</Link>
              </li>
              <li>
                <Link href="#support" className="text-gray-300 hover:text-white transition-colors">Support Center</Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2025 Polifin. All rights reserved.
            </p>
